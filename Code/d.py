...
model = keras.Sequential([
   keras.layers.Dense(train_x.shape[1], activation=tf.nn.relu, input_shape=(train_x.shape[1],)),
...
model.compile(loss=loss, optimizer=tf.train.AdamOptimizer(), metrics=["accuracy"])
